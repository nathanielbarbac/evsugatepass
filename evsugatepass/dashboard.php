    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>" . $row['dh_status'] . "</td>
                    <td>
                        <button class='approve'><a href='approve_request_hr.php?id=" . $row['id'] . "'>Approve</a></button>
                        <button class='reject'><a href='reject_request_hr.php?id=" . $row['id'] . "'>Reject</a></button>
                    </td>
                </tr>";
        }
        echo "</table>";
